...
FormData.prototype._multiPartHeader = function(field, value, options) {
  ...
  if (options.header && !options.combiningHeader) {
  ...
  if(options.combiningHeader && options.header ){
    for (var prop in options.header) {
      if( !(options.header[prop] instanceof Array)){
        options.header[prop] = [options.header[prop]];
      }
    }
